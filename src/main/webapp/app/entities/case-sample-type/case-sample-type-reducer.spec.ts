...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASESAMPLETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CASESAMPLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CASESAMPLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CASESAMPLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CASESAMPLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CASESAMPLETYPE actions', async () => {
      const expectedActions = [
        {
