...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SAMPLETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SAMPLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SAMPLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SAMPLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SAMPLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SAMPLETYPE actions', async () => {
      const expectedActions = [
        {
