...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKPLACE_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKPLACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKPLACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKPLACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKPLACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKPLACE actions', async () => {
      const expectedActions = [
        {
