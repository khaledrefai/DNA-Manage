...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMBERDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEMBERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEMBERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEMBERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEMBERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEMBERDATA actions', async () => {
      const expectedActions = [
        {
