...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASESAMPLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CASESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CASESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CASESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CASESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CASESAMPLE actions', async () => {
      const expectedActions = [
        {
