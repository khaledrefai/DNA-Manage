...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SAMPLESTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SAMPLESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SAMPLESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SAMPLESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SAMPLESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SAMPLESTATUS actions', async () => {
      const expectedActions = [
        {
