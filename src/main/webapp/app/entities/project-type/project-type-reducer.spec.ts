...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTTYPE actions', async () => {
      const expectedActions = [
        {
