...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INHOUSESAMPLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INHOUSESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INHOUSESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INHOUSESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INHOUSESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INHOUSESAMPLE actions', async () => {
      const expectedActions = [
        {
