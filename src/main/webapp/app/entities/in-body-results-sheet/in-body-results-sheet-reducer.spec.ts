...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './in-body-results-sheet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INBODYRESULTSSHEET_LIST actions', async () => {
    ...
    it('dispatches FETCH_INBODYRESULTSSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INBODYRESULTSSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INBODYRESULTSSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INBODYRESULTSSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INBODYRESULTSSHEET actions', async () => {
      const expectedActions = [
        {
