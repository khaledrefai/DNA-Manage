...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INBODYDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_INBODYDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INBODYDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INBODYDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INBODYDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INBODYDATA actions', async () => {
      const expectedActions = [
        {
