...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DNAPROFILETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DNAPROFILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DNAPROFILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DNAPROFILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DNAPROFILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DNAPROFILETYPE actions', async () => {
      const expectedActions = [
        {
